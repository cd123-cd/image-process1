...
class FaceDetector:
    ...
    def rectangle(self, image, mosaic_level):
        ...
        with self.mp_face_detection.FaceDetection(
                min_detection_confidence=0.5) as face_detection:#人脸检测函数参数：min_detection_confidence： 默认为 0.5。人脸检测模型的最小置信值 (0-1之间)，高于该置信度则将检测视为成功。
            ...
            results = face_detection.process(image)# 将每一帧图像传给人脸识别模块
